...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1 ¿Consideras que la union sovietia fue la responsable de que los aliados ganar la segunda guerra mundia? 🙌❓", "Pregunta 4.2 ¿Usted considera que el aguacate es un durazno? 🥑", "Pregunta 4.3 ¿Tulio le baja la novia a Tulio? 🙌🚧🔥", "Pregunta 4.4 ¿Naser es Metrosexual? 🚇🚂🔥", "Pregunta 4.5 ¿Considera que Tulio chambea? 👍❓🔥", "Pregunta 4.6 ¿Se considera que forma parte de los tilines insanos? Argumente su respuesta 🥑📝👍"});
    }
